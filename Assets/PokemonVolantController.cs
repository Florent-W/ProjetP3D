...
public class PokemonVolantController : MonoBehaviour
{
    ...
    private bool estSurSol = true;
    public MonterSurPokemonVolant monterSurPokemonVolantScript;
    ...
    void FixedUpdate()
    {
        ...
        if (valeurBouger.y > 0 && valeurSaut == 0)
        {
        ...
        if(estSurSol == true && monterSurPokemonVolantScript.declencherDialogue == false)
        {
            monterSurPokemonVolantScript.declencherDialogue = true;
        }
        else if(estSurSol == false && monterSurPokemonVolantScript.enabled == true)
        {
            monterSurPokemonVolantScript.declencherDialogue = false;
        }
